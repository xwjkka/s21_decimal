...
Suite *suite_s21_is_less_or_equal() {
  ...
  TCase *temp = tcase_create("test_s21_is_less_or_equal");
  suite_add_tcase(s, temp);

  tcase_add_test(temp, is_less_or_equal_0);
  tcase_add_test(temp, is_less_or_equal_1);
  tcase_add_test(temp, is_less_or_equal_2);
  tcase_add_test(temp, is_less_or_equal_3);
  tcase_add_test(temp, is_less_or_equal_4);
  tcase_add_test(temp, is_less_or_equal_5);
  tcase_add_test(temp, is_less_or_equal_6);
  tcase_add_test(temp, is_less_or_equal_7);
  return s;
}
