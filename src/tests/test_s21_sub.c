...
Suite *suite_s21_sub() {
  ...
  TCase *temp = tcase_create("test_s21_sub");
  suite_add_tcase(s, temp);

  tcase_add_test(temp, sub_0);
  tcase_add_test(temp, sub_1);
  tcase_add_test(temp, sub_2);
  tcase_add_test(temp, sub_3);
  tcase_add_test(temp, sub_4);
  tcase_add_test(temp, sub_5);
  tcase_add_test(temp, sub_6);
  tcase_add_test(temp, sub_7);
  tcase_add_test(temp, sub_8);
  tcase_add_test(temp, sub_9);
  tcase_add_test(temp, sub_10);
  tcase_add_test(temp, sub_11);
  tcase_add_test(temp, sub_12);
  tcase_add_test(temp, sub_13);
  tcase_add_test(temp, sub_14);
  tcase_add_test(temp, sub_15);
  tcase_add_test(temp, sub_16);
  tcase_add_test(temp, sub_17);
  tcase_add_test(temp, sub_18);
  tcase_add_test(temp, sub_19);
  tcase_add_test(temp, sub_20);
  tcase_add_test(temp, sub_21);
  tcase_add_test(temp, sub_22);
  tcase_add_test(temp, sub_23);
  return s;
}
